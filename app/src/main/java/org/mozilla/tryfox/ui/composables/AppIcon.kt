...
fun AppIcon(
    ...
    val (iconResId, contentDescResId) = when {
        ...
        appName == FOCUS -> {
            (if (useSearchResultVariant) R.drawable.ic_focus_debug_foreground else R.drawable.ic_focus) to
                R.string.app_icon_focus_description
        }
        appName == FOCUS_NIGHTLY -> R.drawable.ic_focus_nightly_foreground to R.string.app_icon_focus_description
        appName == FOCUS_BETA -> R.drawable.ic_focus_beta_foreground to R.string.app_icon_focus_description
