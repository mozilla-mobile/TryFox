...
fun AppIcon(
    ...
    val (iconResId, contentDescResId) =
        when {
            appName.contains("reference", ignoreCase = true) ->
                R.drawable.ic_reference_browser to
                    R.string.app_icon_reference_browser_description
            appName.contains("fenix-nightly", ignoreCase = true) ->
                R.drawable.ic_fenix_nightly to
